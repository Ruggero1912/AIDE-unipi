...
## ########################### Classification ###########################
- Preparing Data
    > In the hypothesis that information entropy is equal to zero, what is the scenario in the training set? (tutti nella stessa classe)
    > Discretization
        > Fayyad and Irani Approach
- Decision Tree 
    > How we can build it?
    > What measure we use to split the node?
        ...
        > Gini Index
- Nayve Bayes Method
    > What is the problem? How we resolve it? (Suppose we have dependencies, how to classify?)
...
- Density-based clustering
    ...
    > DBSCAN
        ...
        > How to evaluate the clusters?
            > Can we apply Shiluette? (c'è il problema degli outliers, siluette considera che tutti i punti apparetengano ad un cluster)
    > DENCLUE
        > How it works?
...
- Graph Mining
    ...
    > New Distance
        ...
        > SimRank
            ...
            > Problems?
                > The main problem of this approach is that we have to store s(u, v) and that it is costly O(n^2)
